...
source_path: "taskmanager/scripts/03-generate-duplicate-name-report.js"
...
# taskmanager/scripts/03-generate-duplicate-name-report.js

> Script surface; imports ../lib/common, path

## Key Signals

- Source path: taskmanager/scripts/03-generate-duplicate-name-report.js
- Surface: repo-scripts
- Classification: neutral
- Kind: code
- Language: javascript
...
- Source link target: taskmanager/scripts/03-generate-duplicate-name-report.js
