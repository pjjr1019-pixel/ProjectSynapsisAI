...
interface RootCandidate {
  path: string;
  label: string;
  source: "default" | "workspace" | "user" | "volume";
}
...
export const captureFileAwarenessSnapshot = async (
  options: {
    ...
    volumes?: FileAwarenessSnapshot["volumes"];
    journalCursors?: FileAwarenessSnapshot["journalCursors"];
    monitor?: FileAwarenessSnapshot["monitor"];
    now?: () => Date;
    maxDepth?: number;
    maxEntries?: number;
    maxFiles?: number;
