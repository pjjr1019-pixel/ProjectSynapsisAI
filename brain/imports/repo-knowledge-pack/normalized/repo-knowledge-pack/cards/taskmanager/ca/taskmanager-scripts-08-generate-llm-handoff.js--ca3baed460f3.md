...
source_path: "taskmanager/scripts/08-generate-llm-handoff.js"
...
# taskmanager/scripts/08-generate-llm-handoff.js

> Script surface; imports ../lib/common, fs, path

## Key Signals

- Source path: taskmanager/scripts/08-generate-llm-handoff.js
- Surface: repo-scripts
- Classification: neutral
- Kind: code
- Language: javascript
...
- Source link target: taskmanager/scripts/08-generate-llm-handoff.js
