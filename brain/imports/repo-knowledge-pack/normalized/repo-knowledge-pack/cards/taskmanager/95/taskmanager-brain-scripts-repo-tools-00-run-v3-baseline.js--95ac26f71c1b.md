...
source_path: "taskmanager/brain/scripts/repo-tools/00-run-v3-baseline.js"
source_name: "00-run-v3-baseline.js"
...
score: 110
selected_rank: 242
content_hash: "2ab21346aca5e225f16e7134ae41a5e50baa8bb01e30939dbf68991180a09df4"
...
# taskmanager/brain/scripts/repo-tools/00-run-v3-baseline.js

> Script surface; imports ../lib/common, child_process, path

## Key Signals

- Source path: taskmanager/brain/scripts/repo-tools/00-run-v3-baseline.js
- Surface: brain-scripts
- Classification: neutral
- Kind: code
- Language: javascript
...
- Source link target: taskmanager/brain/scripts/repo-tools/00-run-v3-baseline.js
