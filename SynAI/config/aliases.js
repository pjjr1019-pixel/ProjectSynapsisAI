...
const runtimeRoot = (baseDir) => resolve(baseDir, "packages/Agent-Runtime/src");
const governanceRoot = (baseDir) => resolve(baseDir, "packages/Governance-Execution/src");
const awarenessRoot = (baseDir) => resolve(baseDir, "packages/Awareness-Reasoning/src");
const capabilityCatalogRoot = (baseDir) => resolve(baseDir, "packages/Capability-Catalog");
const desktopRoot = (baseDir) => resolve(baseDir, "apps/desktop/src");
const runtimeAliasEntries = (baseDir) => [
...
export const createSynAiAliasEntries = (baseDir) => [
