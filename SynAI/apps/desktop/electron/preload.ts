...
const api: SynAIBridge = {
  ...
  exportConversationHistory: () => ipcRenderer.invoke(IPC_CHANNELS.exportConversationHistory),
  clearConversationHistory: () => ipcRenderer.invoke(IPC_CHANNELS.clearConversationHistory),
