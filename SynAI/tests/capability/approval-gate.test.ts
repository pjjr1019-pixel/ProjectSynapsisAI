...
import type { CapabilityRemediationPlan } from "../../packages/Awareness-Reasoning/src/capability-eval/types";
...
const plan: CapabilityRemediationPlan = {
...
const retrievalPlan: CapabilityRemediationPlan = {
