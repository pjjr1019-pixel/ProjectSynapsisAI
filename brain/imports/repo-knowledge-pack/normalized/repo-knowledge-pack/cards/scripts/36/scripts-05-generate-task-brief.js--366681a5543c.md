...
source_path: "scripts/05-generate-task-brief.js"
...
# scripts/05-generate-task-brief.js

> Script surface; imports ../lib/common, path

## Key Signals

- Source path: scripts/05-generate-task-brief.js
- Surface: repo-scripts
- Classification: neutral
- Kind: code
- Language: javascript
...
- Source link target: scripts/05-generate-task-brief.js
