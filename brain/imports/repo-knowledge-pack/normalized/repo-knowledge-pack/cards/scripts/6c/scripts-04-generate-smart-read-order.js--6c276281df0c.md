...
source_path: "scripts/04-generate-smart-read-order.js"
...
# scripts/04-generate-smart-read-order.js

> Script surface

## Key Signals

- Source path: scripts/04-generate-smart-read-order.js
- Surface: repo-scripts
- Classification: neutral
- Kind: code
- Language: javascript
...
- Source link target: scripts/04-generate-smart-read-order.js
