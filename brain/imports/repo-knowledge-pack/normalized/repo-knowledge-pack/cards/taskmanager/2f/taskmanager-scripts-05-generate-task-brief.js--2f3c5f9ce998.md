...
source_path: "taskmanager/scripts/05-generate-task-brief.js"
...
# taskmanager/scripts/05-generate-task-brief.js

> Script surface; imports ../lib/common, path

## Key Signals

- Source path: taskmanager/scripts/05-generate-task-brief.js
- Surface: repo-scripts
- Classification: neutral
- Kind: code
- Language: javascript
...
- Source link target: taskmanager/scripts/05-generate-task-brief.js
