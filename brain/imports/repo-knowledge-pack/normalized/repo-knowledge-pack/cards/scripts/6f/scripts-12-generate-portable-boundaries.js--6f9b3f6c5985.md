...
source_path: "scripts/12-generate-portable-boundaries.js"
...
# scripts/12-generate-portable-boundaries.js

> Script surface

## Key Signals

- Source path: scripts/12-generate-portable-boundaries.js
- Surface: repo-scripts
- Classification: neutral
- Kind: code
- Language: javascript
...
- Source link target: scripts/12-generate-portable-boundaries.js
