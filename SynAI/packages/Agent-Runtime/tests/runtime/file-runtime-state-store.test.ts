...
import { FileAgentRuntimeStateStore } from '@agent-runtime/runtime/file-runtime-state-store';
    ...
    try {
      ...
      const checkpoint = createRuntimeCheckpoint({
        ...
        continuation: {
          mode: 'reconstructed',
          resumable: false,
          sourceCheckpointId: 'ckpt-file-1',
          limitation: 'Terminal checkpoint persisted to disk.',
        },
        state: {
          taskId: job.taskId,
        },
