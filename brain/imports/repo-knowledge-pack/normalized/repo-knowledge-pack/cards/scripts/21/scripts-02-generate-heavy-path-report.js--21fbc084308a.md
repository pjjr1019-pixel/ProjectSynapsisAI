...
source_path: "scripts/02-generate-heavy-path-report.js"
...
- Source path: scripts/02-generate-heavy-path-report.js
- Surface: repo-scripts
- Classification: neutral
- Kind: code
- Language: javascript
...
- Source link target: scripts/02-generate-heavy-path-report.js
