...
source_path: "taskmanager/brain/scripts/repo-tools/06-generate-context-pack.js"
...
# taskmanager/brain/scripts/repo-tools/06-generate-context-pack.js

> Script surface; imports ../lib/common, fs, path

## Key Signals

- Source path: taskmanager/brain/scripts/repo-tools/06-generate-context-pack.js
- Surface: brain-scripts
- Classification: neutral
- Kind: code
- Language: javascript
...
- Source link target: taskmanager/brain/scripts/repo-tools/06-generate-context-pack.js
