...
source_path: "scripts/02-generate-architecture-digest.js"
...
# scripts/02-generate-architecture-digest.js

> Script surface

## Key Signals

- Source path: scripts/02-generate-architecture-digest.js
- Surface: repo-scripts
- Classification: neutral
- Kind: code
- Language: javascript
...
- Source link target: scripts/02-generate-architecture-digest.js
