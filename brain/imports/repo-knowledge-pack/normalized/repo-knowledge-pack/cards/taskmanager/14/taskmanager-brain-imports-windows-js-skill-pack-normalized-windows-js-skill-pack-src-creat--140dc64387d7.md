...
source_path: "taskmanager/brain/imports/windows-js-skill-pack/normalized/windows-js-skill-pack/src/createIndex.js"
...
# taskmanager/brain/imports/windows-js-skill-pack/normalized/windows-js-skill-pack/src/createIndex.js

> Code module; imports ./data/controlPanelSkills, ./data/folderSkills, ./data/settingsSkills, ./data/toolSkills

## Key Signals

- Source path: taskmanager/brain/imports/windows-js-skill-pack/normalized/windows-js-skill-pack/src/createIndex.js
- Surface: brain-imports
- Classification: neutral
- Kind: code
- Language: javascript
...
- Source link target: taskmanager/brain/imports/windows-js-skill-pack/normalized/windows-js-skill-pack/src/createIndex.js
