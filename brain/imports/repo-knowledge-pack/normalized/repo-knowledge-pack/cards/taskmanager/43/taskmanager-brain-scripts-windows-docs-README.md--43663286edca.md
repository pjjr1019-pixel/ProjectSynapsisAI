...
source_path: "taskmanager/brain/scripts/windows/docs/README.md"
...
# taskmanager/brain/scripts/windows/docs/README.md

> Script surface; imports ./src; headings CLI examples / Coverage / Extending it

## Key Signals

- Source path: taskmanager/brain/scripts/windows/docs/README.md
- Surface: brain-scripts
- Classification: neutral
- Kind: markdown
- Language: markdown
...
- Source link target: taskmanager/brain/scripts/windows/docs/README.md
