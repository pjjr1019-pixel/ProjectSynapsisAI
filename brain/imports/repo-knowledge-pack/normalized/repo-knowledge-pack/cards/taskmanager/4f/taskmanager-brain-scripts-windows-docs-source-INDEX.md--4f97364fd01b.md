...
source_path: "taskmanager/brain/scripts/windows/docs/source-INDEX.md"
source_name: "source-INDEX.md"
...
# taskmanager/brain/scripts/windows/docs/source-INDEX.md

> Script surface; headings INDEX / settings

## Key Signals

- Source path: taskmanager/brain/scripts/windows/docs/source-INDEX.md
- Surface: brain-scripts
- Classification: neutral
- Kind: markdown
- Language: markdown
...
- Score: 128
- Tags: brain, brain-scripts, docs, index, markdown, md, neutral, scripts
...
- Primary lookup terms: brain, brain-scripts, docs, index, markdown, md, neutral, scripts, taskmanager
- Source link target: taskmanager/brain/scripts/windows/docs/source-INDEX.md
