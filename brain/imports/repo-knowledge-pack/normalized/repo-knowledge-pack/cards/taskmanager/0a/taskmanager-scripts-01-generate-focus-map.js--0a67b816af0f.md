...
source_path: "taskmanager/scripts/01-generate-focus-map.js"
...
# taskmanager/scripts/01-generate-focus-map.js

> Script surface; imports ../lib/common, path

## Key Signals

- Source path: taskmanager/scripts/01-generate-focus-map.js
- Surface: repo-scripts
- Classification: neutral
- Kind: code
- Language: javascript
...
- Source link target: taskmanager/scripts/01-generate-focus-map.js
