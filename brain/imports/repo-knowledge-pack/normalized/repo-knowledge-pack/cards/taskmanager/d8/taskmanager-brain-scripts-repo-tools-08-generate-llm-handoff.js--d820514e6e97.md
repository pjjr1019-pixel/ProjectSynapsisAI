...
source_path: "taskmanager/brain/scripts/repo-tools/08-generate-llm-handoff.js"
...
# taskmanager/brain/scripts/repo-tools/08-generate-llm-handoff.js

> Script surface; imports ../lib/common, fs, path

## Key Signals

- Source path: taskmanager/brain/scripts/repo-tools/08-generate-llm-handoff.js
- Surface: brain-scripts
- Classification: neutral
- Kind: code
- Language: javascript
...
- Source link target: taskmanager/brain/scripts/repo-tools/08-generate-llm-handoff.js
