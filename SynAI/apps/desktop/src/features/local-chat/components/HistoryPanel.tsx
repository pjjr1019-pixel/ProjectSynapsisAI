      ...
      <header className="border-b border-slate-800 px-3 py-2">
        <div className="flex items-center justify-between gap-2">
          <div>
            ...
            <p className="text-[10px] text-slate-400">Browse conversations and turns without scrolling.</p>
          </div>
          <Button className="px-2 py-1 text-[11px]" variant="ghost" onClick={() => void onOpenChat()}>
            Back to Chat
          </Button>
        </div>
      </header>
      ...
      <div className="flex min-h-0 flex-1 flex-col gap-2 overflow-hidden p-2">
        <Card className="space-y-2 p-2">
          <label className="block space-y-1">
            <span className="text-[10px] text-slate-300">Find conversation</span>
            <Input
              value={query}
          ...
          <label className="block space-y-1">
            <span className="text-[10px] text-slate-300">Conversation</span>
            <select
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            <Button className="py-1 text-[11px]" variant="ghost" onClick={onResetTurn} disabled={turns.length === 0}>
              Latest
            </Button>
          </div>
        </Card>

        <Card className="flex min-h-0 flex-1 flex-col gap-2 p-2">
          <div className="flex items-center justify-between gap-2">
            <div>
              <h3 className="text-sm font-semibold text-slate-100">Turn Browser</h3>
