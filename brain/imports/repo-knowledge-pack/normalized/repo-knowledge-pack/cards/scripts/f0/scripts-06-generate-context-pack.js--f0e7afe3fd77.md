...
source_path: "scripts/06-generate-context-pack.js"
...
# scripts/06-generate-context-pack.js

> Script surface; imports ../lib/common, fs, path

## Key Signals

- Source path: scripts/06-generate-context-pack.js
- Surface: repo-scripts
- Classification: neutral
- Kind: code
- Language: javascript
...
- Source link target: scripts/06-generate-context-pack.js
